...
if [ $(dpkg --get-selections | grep easy-rsa | wc -l) -ne 0 ]
then
	mkdir ~/easy-rsa
...
set_var EASYRSA_REQ_PROVINCE    "Kazan"
set_var EASYRSA_REQ_CITY        "Kazan"
...
EOF
	...
	echo "Пакет easy-rsa не установлен! Просьба установить пакет easy-rsa."
fi
